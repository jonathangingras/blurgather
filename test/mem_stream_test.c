...
pruf_test_define(mem_stream, can_open_stream) {
...
pruf_test_define(mem_stream, can_write_to_writable_stream) {
...
pruf_test_define(mem_stream, cannot_write_to_non_writable_stream) {
...
pruf_test_define(mem_stream, write_to_writable_stream_writes_good_value) {
  bg_stream *stream = bg_stream_open(BGSO_MEM, BGSM_WRITE | BGSM_READ);
  char data[] = "hello, it's me";
  size_t data_length = strlen(data) + 1;
...
pruf_test_define(mem_stream, cannot_read_to_non_readable_stream) {
  bg_stream *stream = bg_stream_open(BGSO_MEM, BGSM_WRITE);
  char data[] = "hello, it's me";
  size_t data_length = strlen(data) + 1;
...
pruf_test_define(mem_stream, writing_0_has_no_effect) {
...
pruf_test_define(mem_stream, reading_0_has_no_effect) {
  bg_stream *stream = bg_stream_open(BGSO_MEM, BGSM_READ | BGSM_WRITE);
  char data[] = "hello, it's me";
  size_t data_length = strlen(data) + 1;
  char read_data1[data_length];
...
pruf_test_define(mem_stream, write_to_stream_twice_stores_data_in_good_order) {
  bg_stream *stream = bg_stream_open(BGSO_MEM, BGSM_WRITE | BGSM_READ);
  char data[] = "hello, it's me";
  size_t data_length = strlen(data) + 1;
...
pruf_test_define(mem_stream, write_to_stream_twice_stores_data_in_good_order_when_rewind_between_calls_case_offset_before_length) {
  bg_stream *stream = bg_stream_open(BGSO_MEM, BGSM_WRITE | BGSM_READ);
  char data[] = "it's meou, ";
  size_t data_length = strlen(data) + 1;
...
pruf_test_define(mem_stream, write_to_stream_twice_stores_data_in_good_order_when_rewind_between_calls_case_offset_after_length) {
  bg_stream *stream = bg_stream_open(BGSO_MEM, BGSM_WRITE | BGSM_READ);
...
pruf_test_define(mem_stream, write_to_stream_twice_stores_data_in_good_order_when_rewind_and_forward_between_calls_case_offset_before_length) {
  bg_stream *stream = bg_stream_open(BGSO_MEM, BGSM_WRITE | BGSM_READ);
...
pruf_test_define(mem_stream, allocation_is_dynamic_when_write_512b_buffer) {
  bg_stream *stream = bg_stream_open(BGSO_MEM, BGSM_WRITE | BGSM_READ);
...
pruf_test_define(mem_stream, allocation_is_dynamic_when_write_1024b_buffer) {
  bg_stream *stream = bg_stream_open(BGSO_MEM, BGSM_WRITE | BGSM_READ);
...
pruf_test_define(mem_stream, allocation_is_dynamic_when_write_1536b_buffer) {
  bg_stream *stream = bg_stream_open(BGSO_MEM, BGSM_WRITE | BGSM_READ);
...
pruf_test_define(mem_stream, allocation_is_dynamic_when_write_2048b_buffer) {
  bg_stream *stream = bg_stream_open(BGSO_MEM, BGSM_WRITE | BGSM_READ);
...
pruf_test_define(mem_stream, allocation_is_dynamic_when_write_4194304b_buffer) {
  bg_stream *stream = bg_stream_open(BGSO_MEM, BGSM_WRITE | BGSM_READ);
